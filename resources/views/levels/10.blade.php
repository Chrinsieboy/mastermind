...
<head>
    ...
    <title>Level 10 | BigBrainGame</title>
    ...
    <div class="page-container">
        ...
        <div class="resultnumber">
            <div class="centered">
                ...
                <form method="post">
                    @csrf
                    <input class="form-input" type="text" name="input" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="6" required pattern=".{6,6}" title="Graag 6 cijfers invoeren."><br><br>
