...
<head>
    ...
    <title>Level 1 | BigBrainGame</title>
...
<body>
    <div class="page-container">
        <div class="header">
            ...
            <a href="/spel">
                <i class="fas fa-times fa-2x margin-bottom-10px tourne cross" aria-hidden="true"></i>
            </a>
        </div>
        <div class="resultnumber">
            <div class="centered">
                ...
                <form method="post">
                    @csrf
                    <input class="form-input" type="text" name="input" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="4" required pattern=".{4,4}" title="Graag 4 cijfers invoeren."><br><br>
