...
class MakeNumberController10 extends Controller
{
    public function level(Request $request)
    {
        $combinationCode = ['0', '2', '7', '1', '5', '9']; // Level 10
        $levelTag = 10;
        ...
        if ($request['input']) {
            if ($chars[0] == '0') {
                $full1 = true;
            } else if ($chars[0] == '2' || $chars[0] == '7' || $chars[0] == '1' || $chars[0] == '5' || $chars[0] == '9') {
                $half1 = true;
            } else if ($chars[0] !== '2' || $chars[0] !== '7' || $chars[0] !== '1' || $chars[0] == '5' || $chars[0] == '9') {
                $none1 = true;
            }
            if ($chars[1] == '2') {
                $full2 = true;
            } else if ($chars[1] == '0' || $chars[1] == '7' || $chars[1] == '1' || $chars[1] == '5' || $chars[1] == '9') {
                $half2 = true;
            } else if ($chars[1] !== '0' || $chars[1] !== '7' || $chars[1] !== '1' || $chars[1] == '5' || $chars[1] == '9') {
                $none2 = true;
            }
            if ($chars[2] == '7') {
                $full3 = true;
            } else if ($chars[2] == '0' || $chars[2] == '2' || $chars[2] == '1' || $chars[2] == '5' || $chars[2] == '9') {
                $half3 = true;
            } else if ($chars[2] !== '0' || $chars[2] !== '2' || $chars[2] !== '1' || $chars[2] == '5' || $chars[2] == '9') {
                $none3 = true;
            }
            if ($chars[3] == '1') {
                $full4 = true;
            } else if ($chars[3] == '0' || $chars[3] == '2' || $chars[3] == '7' || $chars[3] == '5' || $chars[3] == '9') {
                $half4 = true;
            } else if ($chars[3] !== '0' || $chars[3] !== '2' || $chars[3] !== '7' || $chars[3] == '5' || $chars[3] == '9') {
                $none4 = true;
            }
            ...
            if ($chars[4] == '5') {
                $full5 = true;
            } else if ($chars[4] == '0' || $chars[4] == '2' || $chars[4] == '7' || $chars[4] == '1' || $chars[4] == '9') {
                $half5 = true;
            } else if ($chars[4] !== '0' || $chars[4] !== '2' || $chars[4] !== '7' || $chars[4] !== '1' || $chars[4] == '9') {
                $none5 = true;
            }
            if ($chars[5] == '9') {
                $full6 = true;
            } else if ($chars[5] == '0' || $chars[5] == '2' || $chars[5] == '7' || $chars[5] == '1' || $chars[5] == '5') {
                $half6 = true;
            } else if ($chars[5] !== '0' || $chars[5] !== '2' || $chars[5] !== '7' || $chars[5] !== '1' || $chars[5] !== '5') {
                $none6 = true;
            }
