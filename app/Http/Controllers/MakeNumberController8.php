...
class MakeNumberController8 extends Controller
{
    public function level(Request $request)
    {
        $combinationCode = ['5', '8', '0', '1', '7', '3']; // Level 8
        $levelTag = 8;
        ...
        if ($request['input']) {
            if ($chars[0] == '5') {
                $full1 = true;
            } else if ($chars[0] == '8' || $chars[0] == '0' || $chars[0] == '1' || $chars[0] == '7' || $chars[0] == '3') {
                $half1 = true;
            } else if ($chars[0] !== '8' || $chars[0] !== '0' || $chars[0] !== '1' || $chars[0] == '7' || $chars[0] == '3'){
                $none1 = true; 
            }
            if ($chars[1] == '8') {
                $full2 = true;
            } else if ($chars[1] == '5' || $chars[1] == '0' || $chars[1] == '1' || $chars[1] == '7' || $chars[1] == '3') {
                $half2 = true;
            }else if ($chars[1] !== '5' || $chars[10] !== '0' || $chars[1] !== '1' || $chars[1] == '7' || $chars[1] == '3'){
                $none2 = true; 
            }
            if ($chars[2] == '0') {
                $full3 = true;
            } else if ($chars[2] == '5' || $chars[2] == '8' || $chars[2] == '1' || $chars[2] == '7' || $chars[2] == '3') {
                $half3 = true;
            }else if ($chars[2] !== '5' || $chars[2] !== '8' || $chars[2] !== '1' || $chars[2] == '7' || $chars[2] == '3'){
                $none3 = true; 
            }
            if ($chars[3] == '1') {
                $full4 = true;
            } else if ($chars[3] == '5' || $chars[3] == '8' || $chars[3] == '0' || $chars[3] == '7' || $chars[3] == '3') {
                $half4 = true;
            }else if ($chars[3] !== '5' || $chars[3] !== '8' || $chars[3] !== '0' || $chars[3] == '7' || $chars[3] == '3'){
                $none4 = true; 
            }
            if ($chars[4] == '7') {
                $full5 = true;
            } else if ($chars[4] == '5' || $chars[4] == '8' || $chars[4] == '0' || $chars[4] == '1' || $chars[4] == '3') {
                $half5 = true;
            }else if ($chars[4] !== '5' || $chars[4] !== '8' || $chars[4] !== '0' || $chars[4] == '1' || $chars[4] == '3'){
                $none5 = true; 
            }
            if ($chars[5] == '3') {
                $full6 = true;
            } else if ($chars[5] == '5' || $chars[5] == '8' || $chars[5] == '0' || $chars[5] == '1' || $chars[5] == '7') {
                $half6 = true;
            }else if ($chars[3] !== '5' || $chars[5] !== '8' || $chars[5] !== '0' || $chars[5] == '1' || $chars[5] == '7'){
                $none6 = true; 
            }
        }
